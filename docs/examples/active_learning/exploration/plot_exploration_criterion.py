...
"""# Impact of the acquisition criterion on exploration"""
...
plt.scatter(
    ...
    points_1[:, 1],
    marker="*",
    label="Learning points from algo with Variance criterion",
)
plt.scatter(
    points_2[:, 0],
    points_2[:, 1],
    marker="*",
    label="Learning points from algo with Standard Deviation criterion",
)
plt.scatter(
    points_2[:, 0],
    points_2[:, 1],
    marker="*",
    label="Learning points from algo with Distance criterion",
)
plt.xlabel(r"$x_1$")
plt.ylabel(r"$x_2$")
plt.legend()
